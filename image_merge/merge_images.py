...
def add_file():
    ...
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요",
                                        ...
                                        initialdir=r"C:\Users\조상연\PycharmProjects\TkinterProject\image_merge")
...
"""이미지 합병 및 시작 버튼 함수"""
def merge_image():
    image_list = list_file.get(0, END) # 모든 파일 목록을 가지고 오기
    ...
    for idx, img in enumerate(images):
        ...
        y_offset += img.size[1]  # height의 값 만큼 더해 줌
